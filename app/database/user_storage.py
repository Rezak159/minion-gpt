...
class UserStorage(BaseStorage):
    ...
    def __init__(self, db_path: str = DB_PATH):
        ...
        self.TARIFF_LIMITS = {
            "free": {"requests_per_day": 17, "tokens_per_day": 10000},
            "pro": {"requests_per_day": 200, "tokens_per_day": 200000},
            "ultra": {"requests_per_day": -1, "tokens_per_day": -1},
        }
    ...
    async def update_usage(
        self, user_id: int, requests_delta: int = 1, tokens_delta: int = 0
    ):
        """
    ...
    async def update_subscription(
        self, user_id: int, tariff: str, expires_at: Optional[str] = None
    ):
        """
